...
class FooterBrandInfo(models.Model):
    ...
    def __str__(self):
        return f"{self.main_text} - {self.sub_text}"
...
class FooterContactInfo(models.Model):
    ...
    # Address Information
    address_line1 = models.CharField(max_length=200, default="123 Wedding Street")
    address_line2 = models.CharField(max_length=200, default="Kolkata, West Bengal 700001")
    
    # Business Hours
    weekday_hours = models.CharField(max_length=100, default="Mon-Fri: 10:00 AM - 8:00 PM")
    weekend_hours = models.CharField(max_length=100, default="Sat-Sun: 11:00 AM - 6:00 PM")
    
    # Contact Section Text
    phone_text = models.CharField(max_length=50, default="Call us anytime")
    whatsapp_text = models.CharField(max_length=50, default="Chat with us")
    email_text = models.CharField(max_length=50, default="Send us an email")
    ...
    def __str__(self):
        return f"Contact: {self.phone} | {self.email}"
...
class FooterSocialMedia(models.Model):
    ...
    def get_icon_svg(self):
        """Return SVG icon for the social media platform"""
        icons = {

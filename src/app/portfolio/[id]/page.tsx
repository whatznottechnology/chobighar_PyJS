            ...
            <div className="lg:col-span-7">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                {portfolio.highlights && portfolio.highlights.length > 0 && (
                  <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-5 border border-red-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <ul className="space-y-2">
                      {portfolio.highlights.map((highlight, index) => (
                        <li key={index} className="flex items-start gap-2 text-sm text-gray-700">
                          ...
                          <span className="leading-snug">{highlight.highlight_text}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                ...
                {portfolio.services && portfolio.services.length > 0 && (
                  <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-5 border border-red-100 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-center gap-2 mb-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {portfolio.services.map((service, index) => (
                        <span
                          key={index}
                          className="inline-flex items-center px-3 py-1.5 bg-white rounded-lg text-xs font-medium text-red-700 border border-red-200 hover:border-red-300 hover:shadow-sm transition-all"
                        >
              ...
              {/* Event Details Card */}
              <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-5 border border-red-100 hover:shadow-lg transition-all duration-300 mt-4">
                <div className="flex items-center gap-2 mb-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-white rounded-lg p-4 border border-red-100">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-red-600">Guests</span>
                    </div>
                    <p className="text-xl font-bold text-gray-900">{portfolio.guests}</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-red-100">
                    <div className="flex items-center gap-2 mb-2">
                      <CameraIcon className="w-5 h-5 text-red-600" />
                      <span className="text-xs font-medium text-red-600">Photos</span>
                    </div>
                    <p className="text-xl font-bold text-gray-900">{portfolio.image_count}</p>
                  </div>
                </div>
              </div>
            </div>
